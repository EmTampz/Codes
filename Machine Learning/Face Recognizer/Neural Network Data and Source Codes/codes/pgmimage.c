...
//  the image package. Supports read/write of
//  PGMimage files and pixel access/assignment. Provides an IMAGE data
//  structure, and an IMAGELIST data structure (an array of pointers to
//  images; useful when handling many images). You will not need to
//  modify any code in this module to complete the assignment
#include <stdio.h>
#include <pgmimage.h>
